...
The first task is to submit sparkApplication on Kubernetes cluster(the example uses spark-wc application).
...
# spark = open(
#     "example_spark_kubernetes_operator_wc.yaml").read()
